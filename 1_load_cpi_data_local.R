...
cpi_data <- read_delim(file = "/Users/mkonczal/Desktop/cu.data.0.Current")
cpi_data <- cpi_data %>%
  clean_names()
...
series <- read_delim(file = "/Users/mkonczal/Desktop/cu.series")
series <- series %>%
  clean_names()
series$series_id <- str_trim(series$series_id)

items <- read_delim(file = "/Users/mkonczal/Desktop/cu.item")
