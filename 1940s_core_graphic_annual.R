...
subtitle <- "Change in year-over-year 'All items less food' CPI inflation from 1 year ago, vs unemployment rate, change < 0."
...
food_series_graphic %>%
  ...
  labs(title = graphic_title,
       subtitle = subtitle,
       caption = "BEA, BLS, seasonally adjusted. Author's Calculations. Mike Konczal, Roosevelt Institute.",
       x = "Unemployment Rate",
